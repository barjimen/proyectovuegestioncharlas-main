...
export default {
  ...
  methods: {
    ...
    async verAlumnos() {
      ...
      this.$router.push(`/perfilprofesor/alumnos?idCurso=${this.idCurso}&activo=true`);
    }
  },
  mounted() {
    servicePerf
...
@media (max-width: 350px) {
  .logo-container[data-v-330e96d8]  {
    left: 0px;
  }
  .profile-container[data-v-330e96d8] {
    right: 0px;
  }
}
